...
def main():
    ...
    if uploaded_file:
        ...
        # 날짜 형식 변경
        start_date = pd.to_datetime("2024-01-29") # 여기서 날짜를 설정하세요
